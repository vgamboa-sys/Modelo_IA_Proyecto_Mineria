...
  // Estado para secciones colapsables (usando Set para múltiples secciones abiertas)
...
  // Función para agregar o eliminar una severidad del Set
...
        // console.log("Alertas recientes cargadas (últimas 3H por severidad):", mappedRecentAlerts); // Descomentar para debug
...
                  No existen alertas recientes en el sistema (últimas 3 horas).
                </div>
              </div>
            ) : (
...
                ) : !hasFullHistory ? (
                  <div className="p-4 text-center text-gray-500">
                    No hay historial completo de alertas disponible.
                  </div>
                ) : (
